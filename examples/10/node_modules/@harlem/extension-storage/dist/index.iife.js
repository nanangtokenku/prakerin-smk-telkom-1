...
${codeFrame}` : message);
  ...
  function createInternalStore(name, initialState, eventBus, options) {
    ...
    function snapshot() {
      ...
      const apply = (branchAccessor = identity, mutationName = MUTATIONS2.snapshot) => {
    ...
    function reset(branchAccessor = identity) {
      resetSnapshot == null ? void 0 : resetSnapshot.apply(branchAccessor, MUTATIONS2.reset);
    }
