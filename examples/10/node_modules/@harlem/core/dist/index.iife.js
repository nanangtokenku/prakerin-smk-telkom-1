...
${codeFrame}` : message);
  ...
  function createInternalStore(name, initialState, eventBus, options) {
    ...
    function hasRegistration(group, name2) {
      var _a3;
      return !!((_a3 = registrations[group]) == null ? void 0 : _a3.has(name2));
    }
    function getRegistration(group, name2) {
      var _a3;
      return (_a3 = registrations[group]) == null ? void 0 : _a3.get(name2);
    }
    ...
    function unregister(group, name2) {
      var _a3;
      (_a3 = registrations[group]) == null ? void 0 : _a3.delete(name2);
    }
    ...
    function mutate(name2, sender, mutator, payload) {
      ...
      try {
        const producedState = (_a3 = producers.write(writeState)) != null ? _a3 : writeState;
    ...
    function action(name2, body) {
      ...
      const action2 = async (payload) => {
        ...
        try {
          const producedPayload = (_a3 = producers.payload(payload)) != null ? _a3 : payload;
